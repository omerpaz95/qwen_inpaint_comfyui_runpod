...
RUN comfy node install --exit-on-fail comfyui-kjnodes@1.2.5 --mode remote
RUN comfy node install --exit-on-fail comfyui-inpaint-cropandstitch@3.0.1
# Could not resolve unknown_registry/SetNode (no aux_id provided) - skipped
...
# The workflow requested: qwenImageEdit_qwenImgEditFp8E4m3fn.safetensors
# Found an available file with a different name in the Qwen-Image-Edit repo. Using that URL and renaming on download.
